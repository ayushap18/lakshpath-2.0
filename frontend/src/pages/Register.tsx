...
const Register = () => {
  ...
  const checks = [
    { text: 'Free AI career assessment', icon: 'psychology', color: '#0da2e7' },
    { text: 'Personalized learning roadmap', icon: 'map', color: '#F59E0B' },
    { text: 'AI interview chat access', icon: 'mic', color: '#8B5CF6' },
    { text: 'No credit card required', icon: 'verified', color: '#10B981' },
  ];

  const HIGHLIGHTS = [
    { value: '50K+', label: 'Students', gradient: 'from-[#0da2e7] to-[#22D3EE]' },
    { value: '94%', label: 'Accuracy', gradient: 'from-[#8B5CF6] to-[#A78BFA]' },
  ...
  return (
    <div className="min-h-screen bg-[#0A0F1C] flex">
      ...
      <motion.div
        ...
        style={{
          background: 'linear-gradient(200deg, #0B1628 0%, #0d2847 40%, rgba(13,162,231,0.10) 100%)',
        }}
      ...
      >
        ...
        <div
          ...
          style={{ background: 'linear-gradient(135deg, #0da2e7, #8B5CF6, #22D3EE)', filter: 'blur(40px)' }}
        />
        ...
        >
          <motion.div
            className="w-9 h-9 rounded-lg bg-gradient-to-br from-[#0da2e7] to-[#22D3EE] flex items-center justify-center"
            animate={{ boxShadow: ['0 0 0px rgba(13,162,231,0)', '0 0 20px rgba(13,162,231,0.4)', '0 0 0px rgba(13,162,231,0)'] }}
            ...
            {HIGHLIGHTS.map((stat, i) => (
              <motion.div
                ...
                whileHover={{
                  y: -4,
                  rotateX: -3,
                  boxShadow: '0 12px 30px rgba(13,162,231,0.15), inset 0 1px 0 rgba(255,255,255,0.08)',
                }}
              >
          ...
          <form onSubmit={handleSubmit}>
            ...
            <motion.div variants={itemVariants}>
              <motion.button
                ...
                whileHover={{
                  y: -2,
                  boxShadow: '0 10px 36px rgba(13,162,231,0.4), 0 0 60px rgba(13,162,231,0.15)',
                }}
                whileTap={{ scale: 0.98, y: 1 }}
                style={{
                  boxShadow: '0 4px 18px rgba(13,162,231,0.3), inset 0 1px 0 rgba(255,255,255,0.1)',
                }}
              >
