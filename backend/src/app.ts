...
app.use(helmet({
  contentSecurityPolicy: env.NODE_ENV === 'production' ? {
    directives: {
      ...
      connectSrc: ["'self'", "https://lumberjack.razorpay.com", "https://api.razorpay.com", "https://generativelanguage.googleapis.com", "https://accounts.google.com", "https://oauth2.googleapis.com", "https://www.googleapis.com"],
      frameSrc: ["https://api.razorpay.com", "https://accounts.google.com", "https://oauth2.googleapis.com"],
      objectSrc: ["'none'"],
